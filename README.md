...
## Installing the Helm Chart of Traefik in HA Mode on Kubernetes
...
ENV=prod
TYPE=private/public
helm install -f ./Traefik-v2-helm/values-$TYPE.yaml ./Traefik-v2-helm --name traefik-$TYPE --namespace network 
```
